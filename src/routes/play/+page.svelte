...
<main>
	...
	{#if game === null}
		...
		<section class="intro">
			<div class="tagline">
				<span>Turn up trump, win tricks — race to 45.</span>
				<HelpDisclosure label="How to play Forty-Fives" triggerText="How to play">
					<ul class="help-list">
						<li>You and your opponent each get five cards.</li>
						<li>
							The next card is turned up and its suit is trump for the hand — holding the
							right ace lets you <em>rob</em> the turn-up.
						</li>
						<li>Every trick is 5 points, plus 5 for taking the highest trump in play.</li>
						<li>Renege rules are enforced, with explanations when a play isn't allowed.</li>
						<li>First to 45 wins.</li>
					</ul>
				</HelpDisclosure>
			</div>

...
<main>
	...
	<header>
		<h1>Auction Stats</h1>
		<p class="subtitle">Lifetime totals for your team. Stored only on this device.</p>
	</header>
	...
	<section class="stats" aria-label="Your statistics">
		...
		<dl class="stat-grid">
			...
			<div class="stat">
				<dt>Won by your team</dt>
				<dd>{pct(stats.tricksWonByTeam, stats.tricksTotal)}</dd>
			</div>
		</dl>
		...
		<dl class="stat-grid">
			...
			<div class="stat">
				<dt>Won by your team</dt>
				<dd>{pct(stats.gamesWonByTeam, stats.gamesTotal)}</dd>
			</div>
		</dl>
	</section>
